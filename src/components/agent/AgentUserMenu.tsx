...
const AgentUserMenu: React.FC<AgentUserMenuProps> = ({ currentAgent, onOpenProfile, onOpenSettings }) => {
    ...
    return (
        <Dropdown placement="bottom-end">
            ...
            <DropdownMenu aria-label="Menú de agente" variant="flat">
...
export default React.memo(AgentUserMenu);
