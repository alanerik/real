...
const MenuDotsIcon = () => (
    ...
    >
        ...
        />
        <path
            d="M12 5.5C11.7239 5.5 11.5 5.27614 11.5 5C11.5 4.72386 11.7239 4.5 12 4.5C12.2761 4.5 12.5 4.72386 12.5 5C12.5 5.27614 12.2761 5.5 12 5.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
        />
        <path
            d="M12 19.5C11.7239 19.5 11.5 19.2761 11.5 19C11.5 18.7239 11.7239 18.5 12 18.5C12.2761 18.5 12.5 18.7239 12.5 19C12.5 19.2761 12.2761 19.5 12 19.5Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
